 ...
 */
	public function testGetViewFilename() {
		...
		$expected = CAKE . 'View' . DS . 'Scaffolds' . DS . 'admin_index.ctp';
		...
		$expected = CAKE . 'View' . DS . 'Scaffolds' . DS . 'admin_view.ctp';
		$this->assertEquals($expected, $result);
 ...
 */
	public function testGetViewFileNameWithTheme() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS .
			'Themed' . DS . 'TestTheme' . DS . 'Posts' . DS . 'scaffold.admin_index.ctp';
		$this->assertEquals($expected, $result);
	}
